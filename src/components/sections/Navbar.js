  ...
  const navLinks = [
    // { name: "Home", href: "/" },
    {
      ...
      submenu: [
        ...
        { name: "World Water Day", href: "/about/world-water-day" },
        { name: "Manufacturing Facility", href: "/about/manufacturing-facility" },
        { name: "Board of Director", href: "/about/board-of-director" },
        { name: "Gallery", href: "/about/gallery" },
        { name: "CSR", href: "/about/CSR" },
        { name: "Doubling Farmer's Income", href: "/about/doubling-farmer-income" },
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: "Core Strength", href: "/business/core-strength" },
        { name: "Other Initiative", href: "/business/other-initiative" },
      ],
    },
    {
      name: "Products",
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: "Bio-logical", href: "/products/bio-logical" },
        { name: "Crops", href: "/products/crops" },
      ],
    },
    {
      name: "Careers",
      ...
      submenu: [
        ...
        { name: "Employee Engagement", href: "/careers/employee-engagement" },
        { name: "Employee Speak", href: "/careers/employee-speak" },
        { name: "Career Philosophy", href: "/careers/career-philosophy" },
        { name: "Current Openings", href: "/careers/current-openings" },
        { name: "In the News", href: "/careers/in-the-news" },
        { name: "Press Releases", href: "/careers/press-releases" },
        { name: "Contribution", href: "/careers/contribution" },
        { name: "Photo & Videos", href: "/careers/photos-videos" },
        { name: "Presentation", href: "/careers/presentations" },
      ],
    },
    {
    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-[1000] transition-all duration-300 ease-out bg-white ${scrolled ? "shadow-[0_8px_32px_rgba(26,77,46,0.1)] py-2 md:py-2" : "py-3 md:py-3"
          } px-4 md:px-8 lg:px-10 flex justify-between items-center`}
      >
