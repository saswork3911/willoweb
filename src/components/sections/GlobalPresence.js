...
export default function GlobalPresence() {
  ...
  return (
    <section className="bg-[#1A4D2E] py-8 sm:py-20 md:py-[20px] lg:py-[20px] px-4 sm:px-6 md:px-12 lg:px-20 relative overflow-hidden">
      ...
      <div className="relative z-[1] text-center">
        ...
        <div className="max-w-full md:max-w-[800px] lg:max-w-[1200px] mx-auto mb-6 sm:mb-6 md:mb-6 lg:mb-4 relative h-[200px] sm:h-[250px] md:h-[350px] lg:h-[300px]">
