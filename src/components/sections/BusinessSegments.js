...
export default function BusinessSegments() {
  const segments = [
    {
      title: "Crop Protection Sciences",
      description:
        "Revolutionary formulations and delivery systems that maximize crop yields while minimizing environmental impact.",
  ...
  return (
    <section className="py-16 sm:py-20 md:py-20 lg:py-[100px] px-4 sm:px-6 md:px-12 lg:px-20 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[1.5fr_1fr_1fr] gap-4 sm:gap-6 md:gap-8 mb-12 md:mb-16 lg:mb-20">
        {segments.map((segment, index) => (
          <div
            key={index}
            className={`relative rounded-2xl overflow-hidden h-[350px] sm:h-[400px] md:h-[500px] lg:h-[600px] cursor-pointer transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_24px_64px_rgba(26,77,46,0.25)] shadow-[0_16px_48px_rgba(26,77,46,0.15)] group ${index === 0 ? "md:col-span-2 xl:col-span-1" : ""
              }`}
          >
            <img
              src={segment.image}
