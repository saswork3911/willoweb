...
export default function Innovation() {
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-0  min-h-[300px] md:min-h-[300px] lg:min-h-[200px] bg-[#F8F8F8]">
      <div className="relative rounded-l-2xl rounded-r-2xl  overflow-hidden  h-[250px] sm:h-[300px] md:h-[300px] lg:h-auto order-1 lg:order-1">
        <Image
          src="https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=800"
          alt="Innovation Lab"
          fill
          
          className="object-cover transition-transform duration-500 hover:scale "
        />
      </div>
