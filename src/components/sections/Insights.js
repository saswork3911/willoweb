...
export default function Insights() {
  ...
  return (
    <section className="py-16 sm:py-20 md:py-32 lg:py-[60px] px-4 sm:px-6 md:px-12 lg:px-10 bg-[#FAFAF5]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-4">
        {insights.map((insight, index) => (
          <div key={index} className="bg-white rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_24px_64px_rgba(26,77,46,0.15)] shadow-[0_8px_24px_rgba(26,77,46,0.08)] cursor-pointer group">
            <div className="w-full h-[180px] sm:h-[200px] md:h-[240px] lg:h-[190px] overflow-hidden">
              <Image
                src={insight.image}
                alt={insight.title}
                width={600}
            ...
            <div className="p-4 sm:p-4 md:p-4">
              ...
              <h3 className="font-montserrat font-bold text-lg sm:text-xl md:text-2xl leading-6 md:leading-8 text-[#1A4D2E] mb-2 md:mb-2">
                {insight.title}
              </h3>

              <p className="text-sm md:text-base leading-5 md:leading-[26px] text-[#666] mb-4 md:mb-2">
                {insight.excerpt}
              </p>
